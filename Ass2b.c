...
int main(int argc, char *argv[]) {
    ...
    pid_t cpid = fork(); // Fork the current process
    ...
    if (cpid > 0) { // Parent process
        ...
        // Creating an ASCII character array to pass as a command-line argument
        arrChar[0] = (char *)"child"; // Arg 0 = name of the executable file
        for (int i = 0; i < n; i++) {
        ...
        execv("./child", arrChar); // Execute another program using execv
